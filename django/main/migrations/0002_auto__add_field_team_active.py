...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field teams on 'Record'
        m2m_table_name = db.shorten_name(u'main_record_teams')
        ...
        db.create_unique(m2m_table_name, ['record_id', 'team_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field teams on 'Record'
        db.delete_table(db.shorten_name(u'main_record_teams'))
    ...
    models = {
        ...
        u'main.record': {
            ...
            'teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'teams'", 'symmetrical': 'False', 'to': u"orm['main.Team']"})
        },
        u'main.recordtype': {
